...
public class ElicomDbContextFactory : IDesignTimeDbContextFactory<ElicomDbContext>
{
    public ElicomDbContext CreateDbContext(string[] args)
    {
        ...
        return new ElicomDbContext(builder.Options);
    }
}
