...
namespace Elicom.Migrations
{
    ...
    [Migration("20260211165625_Renamed_Transaction_Type_To_Movement")]
    partial class Renamed_Transaction_Type_To_Movement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Elicom.Cards.CardApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<long?>("GeneratedCardId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Elicom.Cards.VirtualCard", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Elicom.Entities.AppTransaction", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Elicom.Entities.Carrier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Elicom.Entities.CartItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("ResellerDiscountPercentage")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Elicom.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Elicom.Entities.CustomerProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Elicom.Entities.Product", b =>
                {
                    ...
                    b.Property<decimal>("ResellerMaxPrice")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Elicom.Entities.SmartStoreWallet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SmartStoreWallets");
                });

            modelBuilder.Entity("Elicom.Entities.SmartStoreWalletTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SmartStoreWalletTransactions");
                });
            ...
            modelBuilder.Entity("Elicom.Entities.SupplierOrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Elicom.Entities.SupportTicket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Elicom.Entities.Warehouse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Elicom.Entities.WithdrawRequest", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Elicom.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Elicom.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Elicom.Entities.CartItem", b =>
                {
                    b.HasOne("Elicom.Entities.StoreProduct", "StoreProduct")
                        .WithMany()
            ...
            modelBuilder.Entity("Elicom.Entities.Product", b =>
                {
                    b.HasOne("Elicom.Entities.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("Elicom.Entities.SmartStoreWallet", b =>
                {
                    b.HasOne("Elicom.Authorization.Users.User", "User")
                        .WithOne()
                        .HasForeignKey("Elicom.Entities.SmartStoreWallet", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Elicom.Entities.SmartStoreWalletTransaction", b =>
                {
                    b.HasOne("Elicom.Entities.SmartStoreWallet", "Wallet")
                        .WithMany()
            ...
            modelBuilder.Entity("Elicom.Entities.Store", b =>
                {
                    b.HasOne("Elicom.Authorization.Users.User", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("Elicom.Entities.SupplierOrder", b =>
                {
                    ...
                    b.HasOne("Elicom.Authorization.Users.User", "Reseller")
                        .WithMany()
            ...
            modelBuilder.Entity("Elicom.Entities.SupplierOrderItem", b =>
                {
                    ...
                    b.HasOne("Elicom.Entities.SupplierOrder", "SupplierOrder")
                        .WithMany("Items")
